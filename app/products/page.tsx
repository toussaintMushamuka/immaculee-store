...
function ProductRow({
  ...
  // Calculer directement depuis le produit sans requête API
  ...
  const displayText = `${stockInPurchaseUnits} ${product.purchaseUnit}${
...
export default function ProductsPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    stock: 0,
    purchaseUnitPrice: 0,
    purchaseCurrency: "USD" as "USD" | "CDF",
  });
  ...
  const handleEdit = (product: Product) => {
    ...
    setFormData({
      ...
      stock: product.stock,
      purchaseUnitPrice: (product as any).purchaseUnitPrice || 0,
      purchaseCurrency: (product as any).purchaseCurrency || "USD",
    });
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="purchaseUnitPrice">
                            Prix par unité d'achat (optionnel)
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="purchaseCurrency">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                purchaseCurrency: e.target.value as
                                  | "USD"
                                  | "CDF",
                              })
                            }
